...
squr1=canvas.create_rectangle(120,420,320,620,fill="black")
squr2=canvas.create_rectangle(120,420,320,620,fill="black")
squr3=canvas.create_rectangle(120,420,320,620,fill="black")
squr4=canvas.create_rectangle(120,420,320,620,fill="black")
...
canvas.bind("<Button-3>",mm.rightclk)
canvas.pack()
